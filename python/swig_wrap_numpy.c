...
static PyMethodDef SwigMethods[] = {
	 ...
	 { "intp_cast", _wrap_intp_cast, METH_VARARGS, NULL},
	 { "intp_frompointer", _wrap_intp_frompointer, METH_VARARGS, NULL},
	 { "intp_swigregister", intp_swigregister, METH_VARARGS, NULL},
	 { "new_sizetp", _wrap_new_sizetp, METH_VARARGS, NULL},
	 { "delete_sizetp", _wrap_delete_sizetp, METH_VARARGS, NULL},
	 { "sizetp_assign", _wrap_sizetp_assign, METH_VARARGS, NULL},
	 { "sizetp_value", _wrap_sizetp_value, METH_VARARGS, NULL},
	 { "sizetp_cast", _wrap_sizetp_cast, METH_VARARGS, NULL},
	 { "sizetp_frompointer", _wrap_sizetp_frompointer, METH_VARARGS, NULL},
	 { "sizetp_swigregister", sizetp_swigregister, METH_VARARGS, NULL},
	 { "new_longp", _wrap_new_longp, METH_VARARGS, NULL},
	 { "delete_longp", _wrap_delete_longp, METH_VARARGS, NULL},
	 { "longp_assign", _wrap_longp_assign, METH_VARARGS, NULL},
	 { "longp_value", _wrap_longp_value, METH_VARARGS, NULL},
	 { "longp_cast", _wrap_longp_cast, METH_VARARGS, NULL},
	 { "longp_frompointer", _wrap_longp_frompointer, METH_VARARGS, NULL},
	 { "longp_swigregister", longp_swigregister, METH_VARARGS, NULL},
	 { "new_doublep", _wrap_new_doublep, METH_VARARGS, NULL},
	 { "delete_doublep", _wrap_delete_doublep, METH_VARARGS, NULL},
	 { "doublep_assign", _wrap_doublep_assign, METH_VARARGS, NULL},
	 { "doublep_value", _wrap_doublep_value, METH_VARARGS, NULL},
	 { "doublep_cast", _wrap_doublep_cast, METH_VARARGS, NULL},
	 { "doublep_frompointer", _wrap_doublep_frompointer, METH_VARARGS, NULL},
	 { "doublep_swigregister", doublep_swigregister, METH_VARARGS, NULL},
	 { "new_doubleArray", _wrap_new_doubleArray, METH_VARARGS, NULL},
	 { "delete_doubleArray", _wrap_delete_doubleArray, METH_VARARGS, NULL},
	 ...
	 { "new_longArray", _wrap_new_longArray, METH_VARARGS, NULL},
	 { "delete_longArray", _wrap_delete_longArray, METH_VARARGS, NULL},
	 { "longArray_getitem", _wrap_longArray_getitem, METH_VARARGS, NULL},
	 { "longArray_setitem", _wrap_longArray_setitem, METH_VARARGS, NULL},
	 { "new_intArray", _wrap_new_intArray, METH_VARARGS, NULL},
	 { "delete_intArray", _wrap_delete_intArray, METH_VARARGS, NULL},
	 ...
	 { "delete_stringArray", _wrap_delete_stringArray, METH_VARARGS, NULL},
	 { "stringArray_getitem", _wrap_stringArray_getitem, METH_VARARGS, NULL},
	 { "stringArray_setitem", _wrap_stringArray_setitem, METH_VARARGS, NULL},
	 { "grib_c_new_from_file", _wrap_grib_c_new_from_file, METH_VARARGS, NULL},
	 { "grib_c_new_any_from_file", _wrap_grib_c_new_any_from_file, METH_VARARGS, NULL},
	 { "grib_c_new_bufr_from_file", _wrap_grib_c_new_bufr_from_file, METH_VARARGS, NULL},
	 { "grib_c_new_gts_from_file", _wrap_grib_c_new_gts_from_file, METH_VARARGS, NULL},
	 { "grib_c_new_metar_from_file", _wrap_grib_c_new_metar_from_file, METH_VARARGS, NULL},
	 { "grib_c_iterator_new", _wrap_grib_c_iterator_new, METH_VARARGS, NULL},
	 { "grib_c_keys_iterator_new", _wrap_grib_c_keys_iterator_new, METH_VARARGS, NULL},
	 { "codes_c_bufr_keys_iterator_new", _wrap_codes_c_bufr_keys_iterator_new, METH_VARARGS, NULL},
	 { "grib_c_grib_new_from_samples", _wrap_grib_c_grib_new_from_samples, METH_VARARGS, NULL},
	 { "grib_c_bufr_new_from_samples", _wrap_grib_c_bufr_new_from_samples, METH_VARARGS, NULL},
	 { "grib_c_index_new_from_file", _wrap_grib_c_index_new_from_file, METH_VARARGS, NULL},
	 { "grib_c_index_add_file", _wrap_grib_c_index_add_file, METH_VARARGS, NULL},
	 { "grib_c_new_from_index", _wrap_grib_c_new_from_index, METH_VARARGS, NULL},
	 { "grib_c_index_write", _wrap_grib_c_index_write, METH_VARARGS, NULL},
	 { "grib_c_index_read", _wrap_grib_c_index_read, METH_VARARGS, NULL},
	 { "grib_c_new_from_message", _wrap_grib_c_new_from_message, METH_VARARGS, NULL},
	 { "grib_c_count_in_file", _wrap_grib_c_count_in_file, METH_VARARGS, NULL},
	 { "grib_c_release", _wrap_grib_c_release, METH_VARARGS, NULL},
	 { "grib_c_write", _wrap_grib_c_write, METH_VARARGS, NULL},
	 { "grib_c_get_size_long", _wrap_grib_c_get_size_long, METH_VARARGS, NULL},
	 { "grib_c_get_string_length", _wrap_grib_c_get_string_length, METH_VARARGS, NULL},
	 { "grib_c_clone", _wrap_grib_c_clone, METH_VARARGS, NULL},
	 { "grib_c_copy_namespace", _wrap_grib_c_copy_namespace, METH_VARARGS, NULL},
	 { "grib_c_get_message_size", _wrap_grib_c_get_message_size, METH_VARARGS, NULL},
	 { "grib_c_get_message_offset", _wrap_grib_c_get_message_offset, METH_VARARGS, NULL},
	 { "grib_c_get_native_type", _wrap_grib_c_get_native_type, METH_VARARGS, NULL},
	 { "grib_c_multi_new", _wrap_grib_c_multi_new, METH_VARARGS, NULL},
	 { "grib_c_multi_support_on", _wrap_grib_c_multi_support_on, METH_VARARGS, NULL},
	 { "grib_c_multi_write", _wrap_grib_c_multi_write, METH_VARARGS, NULL},
	 { "grib_c_multi_support_off", _wrap_grib_c_multi_support_off, METH_VARARGS, NULL},
	 { "grib_c_multi_release", _wrap_grib_c_multi_release, METH_VARARGS, NULL},
	 { "grib_c_multi_append", _wrap_grib_c_multi_append, METH_VARARGS, NULL},
	 { "grib_c_gribex_mode_on", _wrap_grib_c_gribex_mode_on, METH_VARARGS, NULL},
	 { "grib_c_gribex_mode_off", _wrap_grib_c_gribex_mode_off, METH_VARARGS, NULL},
	 { "grib_c_keys_iterator_next", _wrap_grib_c_keys_iterator_next, METH_VARARGS, NULL},
	 { "codes_c_bufr_keys_iterator_next", _wrap_codes_c_bufr_keys_iterator_next, METH_VARARGS, NULL},
	 { "grib_c_keys_iterator_delete", _wrap_grib_c_keys_iterator_delete, METH_VARARGS, NULL},
	 { "codes_c_bufr_keys_iterator_delete", _wrap_codes_c_bufr_keys_iterator_delete, METH_VARARGS, NULL},
	 { "grib_c_skip_computed", _wrap_grib_c_skip_computed, METH_VARARGS, NULL},
	 { "grib_c_skip_coded", _wrap_grib_c_skip_coded, METH_VARARGS, NULL},
	 { "grib_c_skip_edition_specific", _wrap_grib_c_skip_edition_specific, METH_VARARGS, NULL},
	 { "grib_c_skip_duplicates", _wrap_grib_c_skip_duplicates, METH_VARARGS, NULL},
	 { "grib_c_skip_read_only", _wrap_grib_c_skip_read_only, METH_VARARGS, NULL},
	 { "grib_c_skip_function", _wrap_grib_c_skip_function, METH_VARARGS, NULL},
	 { "grib_c_keys_iterator_rewind", _wrap_grib_c_keys_iterator_rewind, METH_VARARGS, NULL},
	 { "codes_c_bufr_keys_iterator_rewind", _wrap_codes_c_bufr_keys_iterator_rewind, METH_VARARGS, NULL},
	 { "grib_c_bufr_copy_data", _wrap_grib_c_bufr_copy_data, METH_VARARGS, NULL},
	 { "grib_c_keys_iterator_get_name", _wrap_grib_c_keys_iterator_get_name, METH_VARARGS, NULL},
	 { "codes_c_bufr_keys_iterator_get_name", _wrap_codes_c_bufr_keys_iterator_get_name, METH_VARARGS, NULL},
	 { "grib_c_index_get_size_long", _wrap_grib_c_index_get_size_long, METH_VARARGS, NULL},
	 { "grib_c_index_get_long", _wrap_grib_c_index_get_long, METH_VARARGS, NULL},
	 { "grib_c_index_get_real8", _wrap_grib_c_index_get_real8, METH_VARARGS, NULL},
	 { "grib_c_index_get_string", _wrap_grib_c_index_get_string, METH_VARARGS, NULL},
	 { "grib_c_index_select_long", _wrap_grib_c_index_select_long, METH_VARARGS, NULL},
	 { "grib_c_index_select_real8", _wrap_grib_c_index_select_real8, METH_VARARGS, NULL},
	 { "grib_c_index_select_string", _wrap_grib_c_index_select_string, METH_VARARGS, NULL},
	 { "grib_c_index_release", _wrap_grib_c_index_release, METH_VARARGS, NULL},
	 { "grib_c_iterator_delete", _wrap_grib_c_iterator_delete, METH_VARARGS, NULL},
	 { "grib_c_iterator_next", _wrap_grib_c_iterator_next, METH_VARARGS, NULL},
	 { "grib_c_get_string", _wrap_grib_c_get_string, METH_VARARGS, NULL},
	 { "grib_c_get_string_array", _wrap_grib_c_get_string_array, METH_VARARGS, NULL},
	 { "grib_c_set_string", _wrap_grib_c_set_string, METH_VARARGS, NULL},
	 { "grib_c_get_long", _wrap_grib_c_get_long, METH_VARARGS, NULL},
	 { "grib_c_set_long", _wrap_grib_c_set_long, METH_VARARGS, NULL},
	 { "grib_c_get_double", _wrap_grib_c_get_double, METH_VARARGS, NULL},
	 { "grib_c_set_double", _wrap_grib_c_set_double, METH_VARARGS, NULL},
	 { "grib_c_set_real8_array", _wrap_grib_c_set_real8_array, METH_VARARGS, NULL},
	 { "grib_c_get_real8_array", _wrap_grib_c_get_real8_array, METH_VARARGS, NULL},
	 { "grib_c_get_long_array", _wrap_grib_c_get_long_array, METH_VARARGS, NULL},
	 { "grib_c_set_long_array", _wrap_grib_c_set_long_array, METH_VARARGS, NULL},
	 { "grib_c_get_real8_element", _wrap_grib_c_get_real8_element, METH_VARARGS, NULL},
	 { "grib_c_get_real8_elements", _wrap_grib_c_get_real8_elements, METH_VARARGS, NULL},
	 { "grib_c_set_missing", _wrap_grib_c_set_missing, METH_VARARGS, NULL},
	 { "grib_c_set_key_vals", _wrap_grib_c_set_key_vals, METH_VARARGS, NULL},
	 { "grib_c_is_missing", _wrap_grib_c_is_missing, METH_VARARGS, NULL},
	 { "grib_c_is_defined", _wrap_grib_c_is_defined, METH_VARARGS, NULL},
	 { "grib_c_set_string_array", _wrap_grib_c_set_string_array, METH_VARARGS, NULL},
	 { "grib_set_double_ndarray", _wrap_grib_set_double_ndarray, METH_VARARGS, NULL},
	 { "grib_set_long_ndarray", _wrap_grib_set_long_ndarray, METH_VARARGS, NULL},
	 { "grib_get_double_ndarray", _wrap_grib_get_double_ndarray, METH_VARARGS, NULL},
	 { "grib_get_long_ndarray", _wrap_grib_get_long_ndarray, METH_VARARGS, NULL},
	 { "grib_get_double_ndelements", _wrap_grib_get_double_ndelements, METH_VARARGS, NULL},
	 { "grib_c_find_nearest_single", _wrap_grib_c_find_nearest_single, METH_VARARGS, NULL},
	 { "grib_c_find_nearest_four_single", _wrap_grib_c_find_nearest_four_single, METH_VARARGS, NULL},
	 { "grib_c_get_message", _wrap_grib_c_get_message, METH_VARARGS, NULL},
	 { "grib_c_get_error_string", _wrap_grib_c_get_error_string, METH_VARARGS, NULL},
	 { "no_fail_on_wrong_length", _wrap_no_fail_on_wrong_length, METH_VARARGS, NULL},
	 { "grib_c_get_api_version", _wrap_grib_c_get_api_version, METH_VARARGS, NULL},
	 { "grib_c_gts_header_on", _wrap_grib_c_gts_header_on, METH_VARARGS, NULL},
	 { "grib_c_gts_header_off", _wrap_grib_c_gts_header_off, METH_VARARGS, NULL},
	 { "grib_c_set_definitions_path", _wrap_grib_c_set_definitions_path, METH_VARARGS, NULL},
	 { "grib_c_set_samples_path", _wrap_grib_c_set_samples_path, METH_VARARGS, NULL},
	 { NULL, NULL, 0, NULL }
};
