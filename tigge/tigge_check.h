...
/* 
   S2S/CAWCR: temperature_pl minimum value 75.8671 is not in [160,260] (at 1000hPa!)
*/
   {
      "temperature_pl",
      50,
...
warning: s2s.z_tigge_c_kwbc_20030817000000_ncep_prod_pf_sl_0024_001_0000_tcw.grib2, field 23 [total_column_water_sfc.glob]: total_column_water_sfc.glob minimum value -1.8344 is not in [-1.5,1]
*/
   {
      "total_column_water_sfc.glob",
      -2.0,
      1,
      50,
      150,
...
/* 
warning: s2s.z_s2s_c_babj_20150817000000_glob_prod_cf_1440_000.sl.grib2, field 1709 [soil_moisture_top_100_cm_sfc.glob]: soil_moisture_top_100_cm_sfc.glob minimum value 51.2891 is not in [-1e-17,0]
...
warning: s2s.2015090300.prod.1104.10.pf.19970903.sl.48.grib2, field 220 [soil_moisture_top_100_cm_sfc.glob]: soil_moisture_top_100_cm_sfc.glob minimum value -8.57628e-17 is not in [-1e-18,60]
*/
   {
...
/* 
   S2S/CAWCR: soil_temperature_top_100_cm_sfc.glob minimum value 230.73 is not in [200,230]
*/
   {
...
*/
   {
      "snow_depth_water_equivalent_sfc.glob",
      -4e-19,
      0,
      200,
      15000,
