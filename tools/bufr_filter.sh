...
echo "-# The bufr_filter processes sequentially all bufr messages contained in the input files and applies the rules to each one of them. \\n"
...
echo "\\verbatim"
echo "set unpack=1;"
echo "print \"pressure=[pressure#4] [pressure#4->units]\";"
