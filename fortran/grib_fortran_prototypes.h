...
int grib_f_get_message(int *gid, const void **mess, size_t *len);
int grib_f_get_message_(int *gid, const void **mess, size_t *len);
int grib_f_get_message__(int *gid, const void **mess, size_t *len);
