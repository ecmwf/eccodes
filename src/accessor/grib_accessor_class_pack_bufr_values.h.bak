...
#ifndef eccodes_accessor_pack_bufr_values_h
#define eccodes_accessor_pack_bufr_values_h
...
class grib_accessor_class_pack_bufr_values_t : public grib_accessor_class_gen_t
{
public:
    grib_accessor_class_pack_bufr_values_t(const char* name) : grib_accessor_class_gen_t(name) {}
...
#endif /* eccodes_accessor_pack_bufr_values_h */
