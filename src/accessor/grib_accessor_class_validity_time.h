...
#ifndef eccodes_accessor_validity_time_h
#define eccodes_accessor_validity_time_h
...
class grib_accessor_class_validity_time_t : public grib_accessor_class_long_t
{
public:
...
#endif /* eccodes_accessor_validity_time_h */
