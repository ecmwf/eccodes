...
class grib_accessor_class_g2_aerosol_t : public grib_accessor_class_unsigned_t
{
public:
    grib_accessor_class_g2_aerosol_t(const char* name) : grib_accessor_class_unsigned_t(name) {}
...
#endif /* eccodes_accessor_g2_aerosol_h */
