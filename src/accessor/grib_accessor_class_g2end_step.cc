...
int unpack_one_time_range_long_(grib_accessor* a, long* val, size_t* len){
    grib_accessor_g2end_step_t* self = (grib_accessor_g2end_step_t*)a;
    int err = 0;
...
int unpack_one_time_range_double_(grib_accessor* a, double *val , size_t* len){
    grib_accessor_g2end_step_t* self = (grib_accessor_g2end_step_t*)a;
    int err = 0;
...
int unpack_multiple_time_ranges_long_(grib_accessor* a, long* val, size_t* len){
    grib_accessor_g2end_step_t* self = (grib_accessor_g2end_step_t*)a;
    int i = 0, err = 0;
    grib_handle* h = grib_handle_of_accessor(a);
...
int unpack_multiple_time_ranges_double_(grib_accessor* a, double* val, size_t* len){
    grib_accessor_g2end_step_t* self = (grib_accessor_g2end_step_t*)a;
    int i = 0, err = 0;
    grib_handle* h = grib_handle_of_accessor(a);
...
int pack_long_(grib_accessor* a, const long end_step_value, const long end_step_unit){
    grib_accessor_g2end_step_t* self = (grib_accessor_g2end_step_t*)a;
    grib_handle* h = grib_handle_of_accessor(a);
    int err = 0;
