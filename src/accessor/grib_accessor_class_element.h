...
class grib_accessor_class_element_t : public grib_accessor_class_long_t
{
public:
    grib_accessor_class_element_t(const char* name) : grib_accessor_class_long_t(name) {}
...
#endif /* eccodes_accessor_element_h */
