...
class grib_accessor_class_data_png_packing_t : public grib_accessor_class_values_t
{
public:
    grib_accessor_class_data_png_packing_t(const char* name) : grib_accessor_class_values_t(name) {}
