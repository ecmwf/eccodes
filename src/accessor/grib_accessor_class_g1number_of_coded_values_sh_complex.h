...
#ifndef eccodes_accessor_g1number_of_coded_values_sh_complex_h
#define eccodes_accessor_g1number_of_coded_values_sh_complex_h
...
#endif /* eccodes_accessor_g1number_of_coded_values_sh_complex_h */
