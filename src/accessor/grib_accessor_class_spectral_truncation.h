...
class grib_accessor_class_spectral_truncation_t : public grib_accessor_class_long_t
{
public:
    grib_accessor_class_spectral_truncation_t(const char* name) : grib_accessor_class_long_t(name) {}
