...
class BitmapDataFuncSigConverter(private_method_funcsig_conv.PrivateMethodFuncSigConverter):
    func_conversions = [
...
class BitmapDataAccessorSpecific(AccessorSpecific):
    def __init__(self) -> None:
        super().__init__()

    def update_converters(self, converters):
        converters[Converter.PRIVATE_METHOD_FUNCSIG] = BitmapDataFuncSigConverter
        return converters
