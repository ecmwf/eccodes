...
class DataApplyBitmapDataFuncSigConverter(private_method_funcsig_conv.PrivateMethodFuncSigConverter):
    func_conversions = [
...
class DataApplyBitmapDataAccessorSpecific(AccessorSpecific):
