...
{
    grib_accessor* a = AccessorFactory::instance().build(
        AccessorType{creator->op},
        AccessorName{creator->name},
        AccessorNameSpace{""});

        // TODO(maee): creator->name_space can be NULL
        //AccessorNameSpace{creator->name_space});
    ...
    size_t size = a->get_next_position_offset();
