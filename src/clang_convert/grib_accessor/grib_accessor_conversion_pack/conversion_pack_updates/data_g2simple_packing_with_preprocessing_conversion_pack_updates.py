...
class DataG2simplePackingWithPreprocessingConversionPackUpdates(base_conversion_pack_updates.BaseConversionPackUpdates):
    def __init__(self) -> None:
        super().__init__()

        self._all_function_arg_mappings.update({
            Arg("grib_accessor_class*","super") : Arg("AccessorDataPointer","super"),
            Arg("grib_accessor_class*","super2") : Arg("AccessorDataPointer","super2"),
        })
