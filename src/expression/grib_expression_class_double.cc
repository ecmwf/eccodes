...
int Double::evaluate_long(grib_handle* h, long* lres)
{
    *lres = value_;
    return GRIB_SUCCESS;
}

int Double::evaluate_double(grib_handle* h, double* dres)
{
    *dres = value_;
    return GRIB_SUCCESS;
}

void Double::print(grib_context* c, grib_handle* f, FILE* out)
{
