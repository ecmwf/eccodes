...
const unsigned char bufrEdition0[] = { 0x42, 0x55, 0x46, 0x52, 0x00, 0x00, 0x12, 0x00, 0x00, 0x62, 0x01, 0x80, 0x00, 0x01, 0x00, 0x00, 0x58, 0x09, 0x02, 0x17,
...
int main(int argc, char* argv[])
{
    ...
    int err = codes_bufr_extract_headers_malloc(c, outfile, &header_array, &num_messages, strict_mode);
    if (err) return err;
