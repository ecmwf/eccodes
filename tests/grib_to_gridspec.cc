...
CASE("regular_ll")
{
    SECTION("regular_ll examples")
    {
        const map_count_spec_t specs{
            ...
            { 27, R"({"grid":[1.25,0.833333333333333],"reference":[0.625,0.416666666666667]})" },
            { 28, R"({"grid":[1.25,0.833333333333333]})" },
            { 29, R"({"area":[90,0,-78,360],"grid":[1,1]})" },
            { 30, R"({"grid":[1,1],"reference":[0.5,0.5]})" },
            { 31, R"({"grid":[1,1]})" },
            { 32, R"({"area":[73,-27,33,45],"grid":[0.2,0.2]})" },
            { 33, R"({"area":[73,-27,33,45],"grid":[0.1,0.1]})" },
            { 34, R"({"grid":[0.45,0.3],"reference":[0.225,0.15]})" },
            { 35, R"({"grid":[0.45,0.3]})" },
            ...
            { 40, R"({"grid":[0.1,0.1],"reference":[0.05,0.05]})" },
            { 41, R"({"grid":[0.00833333333333333,0.00833333333333333],"reference":[0.00416666666666667,0.00416666666666667]})" },
            { 42, R"({"area":[73,-27,33,45],"grid":[4,4]})" },
            { 43, R"({"area":[10,-0.5,-10,17.5],"grid":[0.5,0.5]})" },
            { 44, R"({"area":[90,-177.5,-90,182.5],"grid":[5,5]})" },
        };
    ...
    {
        const map_count_spec_t specs{
            { 0, R"({"grid":[1.875,1.25],"order":"i+j+","reference":[0.9375,0.625]})" },
            { 1, R"({"grid":[1.875,1.25],"order":"i+j+","reference":[0,0.625]})" },
            { 2, R"({"grid":[1.875,1.25],"order":"i+j+","reference":[0.9375,0]})" },
            { 3, R"({"grid":[0.5625,0.375],"order":"i+j+","reference":[0.28125,0.1875]})" },
            { 4, R"({"grid":[0.140625,0.09375],"order":"i+j+","reference":[0.070312,0.0468681794286641]})" },

        };

        EXPECT(grib_to_gridspec("grib_to_gridspec/arakawa_c.grib2", specs));
    }
}
#endif
