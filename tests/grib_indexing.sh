...
key name = mars.type
values = pf
key name = mars.channel
values = undef
key name = mars.generation
values = undef
key name = mars.step
values = 12, 24, 48, 60
key name = mars.param
...
values = undef
key name = mars.reftime
values = undef
key name = mars.direction
values = undef
key name = mars.frequency
values = undef
key name = mars.offdate
values = undef
key name = mars.offtime
values = undef
key name = mars.activity
values = undef
key name = mars.dataset
values = undef
key name = mars.tile
values = undef
key name = mars.tileattribute
values = undef
Index count = 384
EOF
